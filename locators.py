...
class BookLocators():
    ...
    #FORMATS_BLOCK = (By.XPATH, '//div[@id="tmmSwatches"]//ul//li//span[@class="a-button-inner"]/a')
    #FORMATS_BLOCK = (By.XPATH, '//div[@id="tmmSwatches"]//ul//li//span[@class="a-button-inner"]/a[not(contains(@href,"javascript"))]')
    #FORMATS_LINKS = (By.XPATH, '//div[@id="tmmSwatches"]//ul//li//span[@class="a-button-inner"]/a')
...
class FormatLocators():
    ...
    LIST_KEYS = (By.XPATH, '//div[@id="detailBullets_feature_div"]/ul/li/span/span[1]') 
    LIST_VALUES = (By.XPATH, '//div[@id="detailBullets_feature_div"]/ul/li/span/span[2]') 
    TABLE_VALUES = (By.XPATH, '//div[contains(@id,"productdetails")]//tbody//tr/td')  
